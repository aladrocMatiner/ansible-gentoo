...
The report summarizes available evidence against the v1 target baseline in `docs/target-system-baseline.md`, including installed time-sync evidence from `docs/installed-time-sync-policy.md`, installed SSH evidence from `docs/installed-ssh-policy.md`, and Portage update/config status from `docs/portage-world-update-policy.md`.

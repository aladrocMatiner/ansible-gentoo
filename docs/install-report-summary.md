...
The report summarizes available evidence against the v1 target baseline in `docs/target-system-baseline.md`, including installed time-sync evidence from `docs/installed-time-sync-policy.md` and installed SSH evidence from `docs/installed-ssh-policy.md`.

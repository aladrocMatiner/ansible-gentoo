...
Cleanup preserves audit bundles by default. Use `make clean-audit CLEAN_RUN_ID=<run-id> I_UNDERSTAND_CLEANUP_DELETE=DELETE` only when the audit evidence is intentionally disposable.

...
The package and service set contributes to the v1 target baseline in `docs/target-system-baseline.md`. Installed time synchronization follows `docs/installed-time-sync-policy.md`.

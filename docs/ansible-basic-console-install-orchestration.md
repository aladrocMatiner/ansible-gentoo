...
Optional variables include `HOSTNAME`, `TIMEZONE`, `LOCALE`, `KEYMAP`, `ENABLE_SSH`, `ADMIN_GROUPS`, `ADMIN_SHELL`, `ADMIN_AUTHORIZED_KEYS_FILE`, `ADMIN_PASSWORD_HASH_FILE`, `ROOT_PASSWORD_HASH_FILE`, `STAGE3_MIRROR`, `STAGE3_CACHE_DIR`, and `PORTAGE_GENTOO_MIRRORS`.

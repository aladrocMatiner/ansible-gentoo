...
Optional variables include `HOSTNAME`, `TIMEZONE`, `LOCALE`, `KEYMAP`, `ENABLE_SSH`, `ENABLE_WIFI`, `ADMIN_GROUPS`, `ADMIN_SHELL`, `ADMIN_SUDO_NOPASSWD`, `ADMIN_AUTHORIZED_KEYS_FILE`, `ADMIN_PASSWORD_HASH_FILE`, `ROOT_PASSWORD_HASH_FILE`, `STAGE3_MIRROR`, `STAGE3_CACHE_DIR`, and `PORTAGE_GENTOO_MIRRORS`.

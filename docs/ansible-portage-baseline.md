...
Mirror behavior follows `docs/download-cache-and-mirror-policy.md`. Portage sync, world-update, and pending config-update behavior follows `docs/portage-world-update-policy.md`.

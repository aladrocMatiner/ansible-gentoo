...
> OpenSpec CLI is not installed. Install it first, then ask me to use `openspec-onboard` again.
...
Ask me to use `openspec-propose` on something you actually want to build. You've got the rhythm now!
```
...
Ask me to use `openspec-propose` to start your first change.
```

...
export ANSIBLE_SSH_CONNECT_TIMEOUT
export ANSIBLE_SSH_SERVER_ALIVE_INTERVAL
export ANSIBLE_SSH_SERVER_ALIVE_COUNT_MAX
...
help:
	@printf '%s\n' \
		...
		'  ANSIBLE_SSH_CONNECT_TIMEOUT=$(ANSIBLE_SSH_CONNECT_TIMEOUT)' \
		'  ANSIBLE_SSH_SERVER_ALIVE_INTERVAL=$(ANSIBLE_SSH_SERVER_ALIVE_INTERVAL)' \
		'  ANSIBLE_SSH_SERVER_ALIVE_COUNT_MAX=$(ANSIBLE_SSH_SERVER_ALIVE_COUNT_MAX)' \

...
- Require resume checks to revalidate disk identity, filesystem UUIDs, mount state, selected profile, filesystem type, stage3 flavor, and confirmation state before continuing.

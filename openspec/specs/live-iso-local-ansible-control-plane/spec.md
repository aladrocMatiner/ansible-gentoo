# live-iso-local-ansible-control-plane Specification

## Purpose
TBD - created by archiving change implement-live-iso-local-ansible-control-plane. Update Purpose after archive.
## Requirements
